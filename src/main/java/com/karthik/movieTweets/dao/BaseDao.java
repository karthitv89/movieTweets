...
public class BaseDao {
	...
	protected BaseDao(MongoClient mongoClient, String databaseName) {
	...
	public Map<String, Object> getConfiguration() {
		...
		if (!authUserRoles.isEmpty()) {
			...
			configuration.put("wtimeout",
					this.mongoClient.getDatabase(MFLIX_DATABASE).getWriteConcern().getWTimeout(TimeUnit.MILLISECONDS));
		}
